...
public final class UserDaoTest extends BaseTest {
	...
	public void testAdd() {
		try {
			User user = new User();
			user.setId("2015-06-28");
			user.setUsername("张三");
			user.setNickname("东风v5");
	...
	public void testGet() {
		try {
			...
			log.info("testGet =====> " + user.getUsername());
			log.info("testGet =====> " + user.getNickname());
