...
"classpath:conf/xml/spring-redis.xml", "classpath:conf/xml/spring-cache.xml"})
public final class RedisAnnotationTest extends BaseTest {
	...
	public void testCacheable() {
		try {
			...
			domain.setId("A201KK2MM");
			domain.setUsername("zhangsan");
			domain.setNickname("haha1");
			domain.setValid(true);
			domain.setLastLoginIp("192.168.5.10");
			domain.setLastLoginTime(new Date());
			User u2= someService.cache(domain);
			System.out.println(JacksonUtil.writeAsString(u2));
	...
	public void testCachePut() {
		try {
			User domain = new User();
			domain.setId("201KK2MM1");
			domain.setUsername("zhangsan");
			domain.setNickname("haha1");
			domain.setValid(true);
			domain.setLastLoginIp("192.168.5.10");
			domain.setLastLoginTime(new Date());
			someService.put(domain);
	 ...
	 */
	@Test
	public void testCachEvict() {
		try {
			someService.evict("A201KK2MM");
			
		} catch (Exception e) {
			log.error("testCachEvict =====> ", e);
		}
	}	
